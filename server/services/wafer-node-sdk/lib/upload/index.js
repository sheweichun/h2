...
module.exports = (req) => {
    ...
    const cos = new CosSdk({
        ...
        Domain: `http://${config.cos.fileBucket}.cos.${config.cos.region}.myqcloud.com/`
        ...
        return new Promise((resolve, reject) => {
            ...
            return new Promise((resolve, reject) => {
                ...
                cos.putObject(params, (err, data) => {
                    ...
                    resolve({
                        imgUrl: `https://${config.cos.fileBucket}.cos.${config.cos.region}.myqcloud.com/${uploadFolder}${imgKey}`,
                        imgUrlv4: `http://${config.cos.fileBucket}.cos${regionMap[config.cos.region]}.myqcloud.com/${uploadFolder}${imgKey}`,
                        size: imageFile.size,
