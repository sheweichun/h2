 ...
 */
function getWxLoginResult (userResult, loginCode, cb) {
  // return cb(null,{
...
function login (opts) {
  ...
  getWxLoginResult(opts.userResult || {}, opts.loginCode, (err, loginResult) => {
    if (err) {
    ...
    let header
    if (loginResult.encryptedData && loginResult.iv) {
      header = {
